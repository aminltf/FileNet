...
using FileNet.WebFramework.Extensions;
...
builder.Services
    .AddRazorPages(opt =>
    {
        ...
        opt.Conventions.AuthorizeFolder("/Departments", "Deps.Manage");
        opt.Conventions.AuthorizeFolder("/Employees", "Employees.Manage");

        // opt.Conventions.AuthorizePage("/Departments/Details", "Docs.Read");
        // opt.Conventions.AuthorizePage("/Employees/Documents", "Docs.Read");

        opt.Conventions.AuthorizePage("/Departments/Create", "Deps.Manage");
        opt.Conventions.AuthorizePage("/Departments/Edit", "Deps.Manage");

        opt.Conventions.AuthorizePage("/Employees/Create", "Employees.Manage");
        opt.Conventions.AuthorizePage("/Employees/Edit", "Employees.Manage");
    })
    .AddViewLocalization()
